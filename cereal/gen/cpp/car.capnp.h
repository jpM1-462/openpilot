...
public:
  ...
  inline float getLeadVelocity() const;
...
public:
  ...
  inline float getLeadVelocity();
  inline void setLeadVelocity(float value);
...
inline float CarControl::HUDControl::Reader::getLeadVelocity() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS);
}

inline float CarControl::HUDControl::Builder::getLeadVelocity() {
  return _builder.getDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS);
}
inline void CarControl::HUDControl::Builder::setLeadVelocity(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS, value);
}
