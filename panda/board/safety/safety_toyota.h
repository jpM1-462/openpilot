...
const int TOYOTA_MAX_RATE_UP = 25;        // ramp up fast
...
// longitudinal limits
const int TOYOTA_MAX_ACCEL = 1350;        // 1.35 m/s2
const int TOYOTA_MIN_ACCEL = -4000;       // -4.0 m/s2

const int TOYOTA_ISO_MAX_ACCEL = 1350;        // 1.35 m/s2
const int TOYOTA_ISO_MIN_ACCEL = -4000;       // -4.0 m/s2
